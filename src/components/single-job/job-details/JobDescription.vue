...
<template>
  <div class="w-full">
    <BodyText>
      ...
      nibh. Nullam mollis. Ut justo. Suspendisse potenti. Sed egestas, ante et vulputate volutpat,
      ...
      Sed semper lorem at felis. Vestibulum volutpat, lacus a ultrices sagittis, mi neque euismod
      dui, eu pulvinar nunc sapien ornare nisl. Phasellus pede arcu, dapibus eu, fermentum et,
      dapibus sed, urna.
    </BodyText>
  </div>
</template>
